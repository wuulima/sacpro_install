...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do SacPro que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador SacPro, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar SacPro\n"
  printf "   [1] Atualizar SacPro\n"
  printf "   [2] Deletar SacPro\n"
  printf "   [3] Bloquear SacPro\n"
  printf "   [4] Desbloquear SacPro\n"
  printf "   [5] Alter. dominio SacPro\n"
  printf "\n"
  read -p "> " option
